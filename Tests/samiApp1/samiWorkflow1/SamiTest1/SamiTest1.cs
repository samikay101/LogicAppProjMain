...
using samiApp1.Tests.Mocks.samiWorkflow1;

namespace samiApp1.Tests
{
    /// <summary>
    /// The unit test class.
    /// </summary>
    [TestClass]
    public class SamiTest1
    {
        /// <summary>
        ...
        public void Setup()
        {
            this.TestExecutor = new TestExecutor("samiWorkflow1/testSettings.config");
        }

        /// <summary>
        /// A sample unit test for executing the workflow named samiWorkflow1 with static mocked data.
        /// This method shows how to set up mock data, execute the workflow, and assert the outcome.
        /// </summary>
        [TestMethod]
        public async Task samiWorkflow1_SamiTest1_ExecuteWorkflow_SUCCESS_Sample1()
        {
            // PREPARE Mock
        ...
        /// <summary>
        /// A sample unit test for executing the workflow named samiWorkflow1 with dynamic mocked data.
        /// This method shows how to set up mock data, execute the workflow, and assert the outcome.
        /// </summary>
        [TestMethod]
        public async Task samiWorkflow1_SamiTest1_ExecuteWorkflow_SUCCESS_Sample2()
        {
            // PREPARE
            // Generate mock trigger data.
            var triggerMockOutput = new WhenAHTTPRequestIsReceivedTriggerOutput();
